...
| ⚡ **Storm** | Speed 2 | Double jump + lightning strike on kill |
...
This project is licensed under the Apache License 2.0. See [LICENSE](https://github.com/Jdoggames4/Astra-Vale-SMP/blob/main/LICENSE) for details.
